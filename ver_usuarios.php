								...
								<?php while ($row = $resultado->fetch_object()){ ?>
									<tr>
										...
										<td>
											...
											<button type="button" class="btn red" onclick="confirmacion('<?php echo $row->nombres; ?>', '<?php echo $row->ape_paterno; ?>', <?php echo $row->id; ?> )" title="Eliminar usuario">Borrar</button>
										</td>
									</tr>
								<?php } ?>
								</tbody>
