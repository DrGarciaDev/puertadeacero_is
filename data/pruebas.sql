...
--
-- Base de datos: `puerta_acero_ing_soft`
--
CREATE DATABASE IF NOT EXISTS `puerta_acero_ing_soft` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `puerta_acero_ing_soft`;
