			      ...
			      <div class="card-stacked">
			        <div class="card-content">
						<form action="" method="">
							...
							<div class="input-field">
							  <i class="material-icons prefix">perm_identity</i>
							  <input type="text" name="Ape_pat" id="Ape_pat" value="<?php if(isset($usuario->ape_paterno)) echo $usuario->ape_paterno; ?>" readonly>
							  <label for="Ape_pat">Apellido paterno</label>
							</div>

							<div class="input-field">
							  <i class="material-icons prefix">perm_identity</i>
							  <input type="text" name="Ape_mat" id="Ape_mat" value="<?php if(isset($usuario->ape_materno)) echo $usuario->ape_materno; ?>" readonly>
							...
							<div class="input-field">
							  <i class="material-icons prefix">email</i>
							  <input type="text" name="Telefono" id="Telefono" value="<?php if(isset($usuario->telefono)) echo $usuario->telefono; ?>" readonly>
							  <label for="Telefono" >Telefono</label>
							</div>

							<div class="input-field">
							  <i class="material-icons prefix">https</i>
							  <input type="text" name="Tipo" id="Tipo" value="<?php if(isset($usuario->tipo)) echo $usuario->tipo; ?>" readonly>
