  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_SESSION['usuario'])){
      ...
      */
      ...
      $sql = "SELECT * FROM usuarios WHERE correo = '".htmlentities($correo)."' ";
      ...
      ///  header("location: ../index");
        ...
        if( password_verify( $pass, $fila_resultante['contrasena']) ) {
          ...
          $_SESSION['ape_pat']  = $fila_resultante["ape_paterno"];
          $_SESSION['ape_mat']  = $fila_resultante["ape_materno"];
          $_SESSION['telefono'] = $fila_resultante["telefono"];
          $_SESSION['correo']   = $fila_resultante["correo"];
          $_SESSION['tipo']     = $fila_resultante["tipo"];
        }else{
